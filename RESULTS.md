...
|---|---|---|---|---|---|---|---|---|
| **max-speed-lean (`--vae-pieces 13 VAE_DEFER_LATE=1`, flush active from Exp830, Exp643/708/711/732/766/781/784/785/786/830)** | 1.75 GB | **2.12** | **2.29** | **2.37** | **2.42** | **2.14** | **4.65 %**† | **1.75 GB** |
...
| **max-speed (shipped, **v4.7** — v4.6 + single-pass boundary-token prefill, Exp708/709/765/766/781/784/785/821/829/835)** | 2.19 GB | **1.88** | **2.05** | **2.14** | **2.20** | **1.93** | **4.51 %** | 2.19 GB |

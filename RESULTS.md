...
| sustained 138 s | RTF **2.565** (v3.8 stack, Exp679; the v3.5-era value was 2.80), **888** tokens (marginal class), majflt 0. Memory sampled during the run rather than only at exit: 17 samples over 5.4 min, RSS **2199–2253 MB**, trend **−1.2 MB/min**, peak (VmHWM) 2253.6 MB — the extra graph nodes from the three fusions cost nothing on long runs |

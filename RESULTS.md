...
|---|---|---|---|---|---|---|---|---|
| **max-speed-lean (`--vae-pieces 13 VAE_DEFER_LATE=1`, flush active from Exp830, Exp643/708/711/732/766/781/784/785/786/830/845; cells measured in the pre-Exp845 (warmer) state - today it reads 2.10 on the protocol clip, i.e. the same -0.9 % state drift)** | 1.75 GB | **2.12** | **2.29** | **2.37** | **2.42** | **2.14** | **4.65 %**† | **1.75 GB** |

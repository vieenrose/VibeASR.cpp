...
> Re-measured on the current default (**v4.3**, m2 kernel + one-pass fused gelu): 10 s 2.30, 17 s 2.28, 69 s 2.32, 138 s 2.38, 40-utt mean **2.5742** (tag `gelufuse781`, **40/40 byte-identical** to `gatem2`, b=0/c=0 of 731, McNemar p=1.0); lean 10 s 2.44, 17 s 2.42, 69 s 2.45 (2 reps each, RSS 1752 MB unchanged). The lean 40-utt mean carries its pre-fusion value scaled by the measured tier delta and is marked ° until re-run.

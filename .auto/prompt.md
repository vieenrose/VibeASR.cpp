...
**Current best: 2.18 (MAX-SPEED v4.5, p1 + defer-OFF + conv-int8 + m2 tail kernel + fused gelu + fused rms_norm·gamma + in-kernel conv left pad) = -81.7 %; RAM-lean
v4.4 (p13 + defer ON) ~2.43 @ 1.75 GB. Rows below marked F16/BALANCED/FAST-LM are

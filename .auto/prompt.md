...
**Current best: 1.85 (MAX-SPEED v4.8, p1 + defer-OFF + conv-int8 + m2 tail kernel + fused gelu + fused rms_norm·gamma + in-kernel conv left pad + v4.6 final-window flush (Exp829/830) + v4.7 single-pass boundary-token prefill (Exp835)) = -84.7 %; RAM-lean
